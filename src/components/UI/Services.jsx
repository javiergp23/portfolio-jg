    ...
    <section id='services'> 
        <div className='container lg:pt-5'>
            <div className='text-center'>
                ...
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perspiciatis aliquid illo sit perferendis molestias facilis tempore, repellendus debitis! Rerum, omnis! Recusandae officia doloribus molestias accusamus iusto cupiditate placeat neque obcaecati!    
                </p>
            </div>
                                    ...
                                    <div className='w-full sm:w-1/2 sm:pr-8'>
                                        <div data-aos="fade-left" data-aos-delay="50" data-aos-duration="1300" className='bg-white p-4 rounded shadow group hover:bg-primaryColor cursor-pointer ease-in duration-150'>
                                            ...
                                            <p className='text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7'>
                                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident facere hic rem.
                                            </p>
                                        </div>
                                    </div>
                                </div>
